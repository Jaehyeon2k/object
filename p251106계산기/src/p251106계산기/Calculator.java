...
public class Calculator extends JFrame {
	...
	// 생성자
	public Calculator(String title1) {
		setTitle(title1);
		setSize(600,400);
		...
		middlePanel2.setBounds(0, 120, 600, 60);
		middlePanel2.setBackground(new Color(0, 255, 0));
		JPanel middlePanel3 = new JPanel();
		middlePanel3.setBounds(0, 180, 600, 60);
		middlePanel3.setBackground(new Color(0, 0, 255));
		
		JPanel bottomPanel = new JPanel(); //하
		bottomPanel.setBounds(0, 240, 600, 160);
		...
		middlePanel3.add(multiplyButton);
		middlePanel3.add(divideButton);
